...
const cardData = [
  {
    ...
    image: Rejuvenation,
    description:
      "There are several therapies in Ayurveda which helps in the treatment of musculoskeletal diseases like slip disc, joint pains, arthritis of different kind, spondylosis and spondylitis. It is also used in the treatment of neurological diseases, skin disorders, obesity, stress, depression, insomnia and migraine.",
    direction: "row",
  ...
  },
  {
    ...
    image: Panchakarma,
    description:
      "Panchakarma literally meaning five purificatory procedures are specialized treatment techniques used in Ayurveda for detoxification, to improve health and to treat specific diseases.",
  ...
  },
  {
    ...
    image: Yoga,
    description:
      "Yoga is a life style. Most recent researches prove that Yoga is not just a health practice but also a treatment modality for systemic disorders. We teach Yoga to kids and for the elderly for its health benefits. We also provide therapeutic yoga sessions for specific disorders like diabetes, hypertension, obesity, stress, depression, insomnia, menstrual disorders and hormonal problems. ",
    direction: "row",
    readmore: "/yoga",
  },
];
...
const ServiceCards = () => {
  return <div className="servicecards">{serviceCards}</div>;
};
